...
1. Добавьте репозиторий в список дополнительных:
    ...
    1. Скопируйте `[https://github.com/alryaz/hass-pik-comfort](https://github.com/kosumosu/hass-pik-comfort)` в поле вводавыберите _Интеграция (Integration)_ в выпадающем списке -> Нажмите _Добавить (Add)_
